...
const printQuantity = () => {
  ...
  let productsListLength = valueGoods
  cartQuantity.textContent = productsListLength
...
const generateCartProduct = (img, title, price, text, value, id) => {
  return `
<li class="cart-content__item">
    <article class="cart-content__product cart-product row" data-id="${id}">
    <div class="col-md-4">
        <img src="${img}" alt="" class="cart-product__img">
    </div>

        <div class="cart-product__text col-md-7">
            <h3 class="small-title">${title}</h3>
            <p class="cart-product__text">${text}</p>

            <p class="cart-product__value">Количество: ${value}шт</p>
